...
UserRegisterConfirmPhoneModel userRegisterConfirmPhoneModelFromJson(String str) => UserRegisterConfirmPhoneModel.fromJson(json.decode(str));
String userRegisterConfirmPhoneModelToJson(UserRegisterConfirmPhoneModel data) => json.encode(data.toJson());
