...
UserShowOrderModel userShowOrderModelFromJson(String str) =>
    UserShowOrderModel.fromJson(json.decode(str));

String userShowOrderModelToJson(UserShowOrderModel data) =>
    json.encode(data.toJson());

class UserShowOrderModel {
  UserShowOrderModel({
    int? status,
    String? message,
  ...
  UserShowOrderModel.fromJson(dynamic json) {
    _status = json['status'];
...
OrderProducts orderProductsFromJson(String str) =>
    OrderProducts.fromJson(json.decode(str));
