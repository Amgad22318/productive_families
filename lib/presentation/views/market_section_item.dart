...
class MarketSectionItem extends StatefulWidget {
  final int? index;
   bool isMarket;
   MarketSectionItem({Key? key, required this.index, this.isMarket=false,}) : super(key: key);
  ...
  widget.isMarket=!widget.isMarket;
        ...
        child: Stack(fit: StackFit.passthrough,
          children: [
            ...
            Positioned.fill(child: Container(color:widget.isMarket?  Colors.white.withOpacity(0.5):Colors.transparent,))
