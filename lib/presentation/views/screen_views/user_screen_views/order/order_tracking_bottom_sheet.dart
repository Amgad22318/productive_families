...
class OrderTrackingBottomSheet extends StatelessWidget {
  ...
  final TextEditingController FamilycommentController = TextEditingController();
  final TextEditingController RepresentativecommentController = TextEditingController();
