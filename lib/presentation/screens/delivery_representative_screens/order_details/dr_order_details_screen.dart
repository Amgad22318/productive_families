...
class DeliveryRepresentativeOrderDetailsScreen extends StatefulWidget {
  const DeliveryRepresentativeOrderDetailsScreen({Key? key}) : super(key: key);

  @override
  State<DeliveryRepresentativeOrderDetailsScreen> createState() => _DeliveryRepresentativeOrderDetailsScreenState();
}

class _DeliveryRepresentativeOrderDetailsScreenState extends State<DeliveryRepresentativeOrderDetailsScreen> {
