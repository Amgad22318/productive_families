...
class OrderLocationPickingScreen extends StatefulWidget {
  ...
  const OrderLocationPickingScreen({Key? key}) : super(key: key);

  @override
  State<OrderLocationPickingScreen> createState() => _OrderLocationPickingScreenState();
}

class _OrderLocationPickingScreenState extends State<OrderLocationPickingScreen> {
