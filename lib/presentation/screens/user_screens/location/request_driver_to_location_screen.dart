...
class RequestDriverToLocationScreen extends StatefulWidget {
  final UserRequestDriverCubit userRequestDriverCubit;

  const RequestDriverToLocationScreen(
      {Key? key, required this.userRequestDriverCubit})
      : super(key: key);

  @override
  State<RequestDriverToLocationScreen> createState() =>
      _RequestDriverToLocationScreenState();
}

class _RequestDriverToLocationScreenState
    extends State<RequestDriverToLocationScreen> {
                ...
                Positioned.fill(
                  child: DefaultMap(
                    onTap: (argument) {
                      ...
                      widget.userRequestDriverCubit.getToAddress(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DefaultFormField(
                              ...
                              controller: widget
                                  .userRequestDriverCubit.toLocationController,
