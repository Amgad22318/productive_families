...
class GuestAboutProduct extends StatefulWidget {
  ...
  @override
  State<GuestAboutProduct> createState() => _GuestAboutProductState();
}

class _GuestAboutProductState extends State<GuestAboutProduct> {
      ...
      appBar: DefaultShopAppbar(
        ...
        leading: IconButton(
            onPressed: () {
              showDialog(
                context: context,
                builder: (context) => GuestYouNeedToLoginDialog(),
              );
            },
